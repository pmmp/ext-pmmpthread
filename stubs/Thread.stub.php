...
abstract class Thread extends Runnable
{
	...
	/**
	 * @var int
	 * @cvalue PTHREADS_INHERIT_CONSTANTS
	 *
	...
	/**
	 * @var int
	 * @cvalue PTHREADS_INHERIT_FUNCTIONS
	 *
	...
	/**
	 * @var int
	 * @cvalue PTHREADS_INHERIT_CLASSES
	 *
	...
	/**
	 * @var int
	 * @cvalue PTHREADS_INHERIT_INCLUDES
	 *
	...
	/**
	 * @var int
	 * @cvalue PTHREADS_INHERIT_COMMENTS
	 *
